...
sample["directors"].each do |director|
  directors[director["slug"]] = Director.create!
  director.slice("first_name", "last_name")
end

# puts "Creating actors..."
# actors = {}
# sample["actors"].each do |actor|
#   actors[actor["slug"]] = Actor.create!
#   actor.slice("first_name", "last_name")
# end
